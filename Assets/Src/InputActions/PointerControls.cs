...
//     version 1.4.4
//     from Assets/InputActions/PointerControls.inputactions
//
...
public partial class @PointerControls : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Mouse"",
            ""id"": ""b71c1ac1-9d54-45b1-a5c1-451b527c637e"",
            ""actions"": [
                {
                    ""name"": ""Scroll"",
                    ""type"": ""Value"",
                    ""id"": ""6f62d98d-f4ff-4f20-881a-d74ad2158307"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""e9c64947-27de-4611-a205-28cddb1e020a"",
                    ""path"": ""<Mouse>/scroll"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse"",
    ...
    ""controlSchemes"": [
        ...
        m_All_PositionOnScreen = m_All.FindAction("PositionOnScreen", throwIfNotFound: true);
    ...
    private readonly InputAction m_All_PositionOnScreen;
    ...
    public struct AllActions
    {
        ...
        public AllActions(@PointerControls wrapper) { m_Wrapper = wrapper; }
        public InputAction @PositionOnScreen => m_Wrapper.m_All_PositionOnScreen;
        ...
        public void SetCallbacks(IAllActions instance)
        {
            ...
            {
                @PositionOnScreen.started -= m_Wrapper.m_AllActionsCallbackInterface.OnPositionOnScreen;
                @PositionOnScreen.performed -= m_Wrapper.m_AllActionsCallbackInterface.OnPositionOnScreen;
                @PositionOnScreen.canceled -= m_Wrapper.m_AllActionsCallbackInterface.OnPositionOnScreen;
    ...
    {
        private @PointerControls m_Wrapper;
        public MouseActions(@PointerControls wrapper) { m_Wrapper = wrapper; }
